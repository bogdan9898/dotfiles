...
alias pacmanrm="sudo pacman -Runs" # $ usage: pacmanrm package_name
alias mmap="k4dirstat"
alias ocr_eng="spectacle -rb -o /tmp/ocr_ss_tmp.png -n && tesseract /tmp/ocr_ss_tmp.png - | clipin"
#alias screenshot_to_clipboard= "spectacle -rbc"
alias ocr_timestamp_start="echo \"\" | xclip -selection clipboard -i -rmlastnl; spectacle -bn -o /tmp/ocr_full_ss_timestamp.png && python3 /home/bogdan/Desktop/documentaries/ocr_timestamps.py -s"
alias ocr_timestamp_end="echo \"\" | xclip -selection clipboard -i -rmlastnl; spectacle -bn -o /tmp/ocr_full_ss_timestamp.png && python3 /home/bogdan/Desktop/documentaries/ocr_timestamps.py -e | xclip -selection clipboard -i -rmlastnl"
alias mrm="mpv \"/home/bogdan/Desktop/documentaries/Once Upon a Time in Iraq (full documentary) by FRONTLINE.webm\" --osd-fractions --osd-level=2 --osd-align-x=left --osd-align-y=bottom --osd-margin-y=50"
